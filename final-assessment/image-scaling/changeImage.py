...
# Degree of rotation
rotation_degree = 0 # Change this to your desired degree
...
for image_file in image_files:
    ...
    try:
        ...
        rotated_img = img.rotate(rotation_degree).resize((600,400))

        # Save the rotated image as JPEG in the output folder
        rotated_image_path = os.path.join(script_directory + "/" + images_folder_path, f"{os.path.splitext(image_file)[0]}.jpeg")
